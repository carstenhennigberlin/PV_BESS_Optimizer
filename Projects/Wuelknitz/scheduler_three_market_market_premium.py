...
def get_daa_schedule(pv_output, daa, market_premium, p_limit, storage_capacity, p_charge_max, p_discharge_max, number_of_cycles=2, efficiency=0.95, start_soc=0.0, end_soc=0.0):
    """    
...
def get_ida_schedule(ida, market_premium, pv_output, p_limit, storage_capacity, p_charge_max, p_discharge_max, p_charge_daa, p_discharge_daa, p_curtailed_daa, number_of_cycles=2, efficiency=0.95, start_soc=0.0, end_soc=0.0):
    """
...
def get_idc_schedule(idc, market_premium, pv_output, p_limit, storage_capacity, p_charge_max, p_discharge_max, p_charge_daa_ida, p_discharge_daa_ida, p_curtailed_daa_ida, number_of_cycles=2, efficiency=0.95, start_soc=0.0, end_soc=0.0):
    """
